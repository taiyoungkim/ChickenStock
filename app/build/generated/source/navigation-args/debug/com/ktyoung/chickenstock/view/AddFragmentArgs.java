...
public class AddFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private AddFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private AddFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static AddFragmentArgs fromBundle(@NonNull Bundle bundle) {
    AddFragmentArgs __result = new AddFragmentArgs();
    bundle.setClassLoader(AddFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    AddFragmentArgs that = (AddFragmentArgs) object;
  ...
  public static class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(AddFragmentArgs original) {
    ...
    @NonNull
    public AddFragmentArgs build() {
      AddFragmentArgs result = new AddFragmentArgs(arguments);
      return result;
    }
